...
import getAccountContactNotifications from "@salesforce/apex/ContactNotificationController.getAccountContactNotifications";
...
export default class ContactNotificationsAccount extends LightningElement {
  @api recordId;
  ...
  @wire(getAccountContactNotifications, { accountId: "$recordId" })
  wiredTasks(result) {
